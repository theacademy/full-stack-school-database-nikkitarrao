...
public class StudentDaoImpl implements StudentDao {
    ...
    public Student createNewStudent(Student student) {
        ...
        GeneratedKeyHolder keyholder = new GeneratedKeyHolder(); // captures the auto generated key
        jdbcTemplate.update(connection -> {
            PreparedStatement ps = connection.prepareStatement(INSERT_STUDENT, Statement.RETURN_GENERATED_KEYS);
            ps.setString(1, student.getStudentFirstName()); //setting the parameters in the prepared statement
    ...
    public void deleteStudent(int id) {
        ...
        jdbcTemplate.update(DELETE_COURSE_STUDENT, id); //deleting the reference from course_student
